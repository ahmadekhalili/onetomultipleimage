# Generated by Django 5.0.5 on 2024-05-11 09:48
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('onetomultipleimage', '0004_remove_imagesizes_father_delete_fatherimage_and_more'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sizes', onetomultipleimage.models.ListCharField(max_length=255, verbose_name='sizes')),
            ],
            options={
                'verbose_name': 'Image',
                'verbose_name_plural': 'Images',
                'db_table': 'fatherimage',
            },
        ),
        migrations.CreateModel(
            name='ImageSizes',
